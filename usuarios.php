        ...
        <div class="container">
            ...
            <div class="table-container">
                <div class="header-actions">
                    <button class="btn-new modal-trigger" id="btn-novo-usuario">+ Novo Usuário</button>
                    <button class="btn-new modal-trigger" id="btn-gerenciar-grupos">⚙ Gerenciar Grupos</button>
                </div>
